...
const adminService = {
    ...
    userlist: (req, res) => {
        ...
        const itemsPerPage = 10; // 한 페이지당 사용자 수
        ...
        adminModel.getTotalUsersCount((error, totalCount) => {
            ...
            const paginationData = getPaginationData(currentPage, totalPages, '/admin/userlist?page=');
    ...
    adminlist: (req, res) => {
        ...
        const pageQuery = req.query.page || 1;
        const currentPage = parsePageNumber(pageQuery);
        const itemsPerPage = 10; // 한 페이지당 관리자 수
        ...
        adminModel.getTotalAdminsCount((error, totalCount) => {
            ...
            const { totalPages, offset } = calculatePagination(totalCount, itemsPerPage, currentPage);
            const paginationData = getPaginationData(currentPage, totalPages, '/admin/adminlist?page=');
